...
- **Path:** consensus, non-consensus / Code of Conduct
- **Resolution route:** resolved internally ('how AI is used here'), escalated to the builder ('the model misbehaved')
