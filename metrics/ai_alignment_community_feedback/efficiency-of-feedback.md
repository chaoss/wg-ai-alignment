...
The cost of the loop to each side. On the community side, the effort to give feedback and the wait for a response. On the model-builder side, the effort and cost to respond and implement. Neither side's time is free.
...
- **Cost to:** community, provider
- **Effort to give feedback:** single message, incident report, blog post, multi-project letter
